    ...
    if (!isSigningIn) {
      ...
      try {
        ...
        if (error.code === "auth/user-not-found") {
          ...
          setErrorMessage("This operation is restricted. Contact support.");
        } else {
  ...
  return (
    <div className="bg-white dark:bg-black">
      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center">
        <div className="w-96 text-gray-600 dark:text-white bg-white dark:bg-black space-y-5 p-4 shadow-xl border rounded-xl">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium  ${
              isSigningIn
                ? "cursor-not-allowed"
                : "hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300 active:bg-gray-100"
            }`}
          >
            <svg
              className="w-5 h-5"
